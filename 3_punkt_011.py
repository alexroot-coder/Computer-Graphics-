...
while run:
    ...
    for i in range(0,len(b)):
        asd = draw_line(window,b[i][0],b[i][1],b[tmp][0],b[tmp][1])
        lines.append(asd)
        tmp = i
...
#        y2 = 100
    ...
    for i in range(len(aa)):
       ...
       #color = (i,i,i)
       aaa = fill_polygon(window,aa[0][0],aa[0][1],aa[-1][0],aa[-1][1])
            #draw_line(window,tmp1[0][0],tmp1[0][1],tmp1[1][0],tmp1[1][1])
